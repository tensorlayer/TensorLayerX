...
def test_conv2d():
    ...
    #     in_channels=3, filter_size=(3, 3), strides=(1, 1), dilation_rate=(2, 2), act=tlx.ReLU, depth_multiplier=2,
    #     name='depthwise'
    # )
...
def test_pooling():
    ...
    #     filter_size=(3, 3, 3), strides=(2, 2, 2), padding='SAME', name='test_meanpool3d', data_format='channels_first'
    # )(nin_3)
