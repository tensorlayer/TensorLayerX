...
class Layer_Convolution_1D_Test(CustomTestCase):
    ...
    def setUpClass(self):
        ...
        self.conv1dlayer1 = tensorlayerx.layers.Conv1d(in_channels=1, n_filter=32, filter_size=5, stride=2)
        ...
        self.separableconv1d2 = tensorlayerx.layers.SeparableConv1d(
            in_channels=1, n_filter=16, filter_size=3, stride=2, depth_multiplier=4
        )
        self.n5 = self.separableconv1d2(self.input_layer)

        self.separableconv1d3 = tensorlayerx.layers.SeparableConv1d(
...
class Layer_Convolution_2D_Test(CustomTestCase):
    ...
    def setUpClass(self):
        ...
        self.conv2dlayer1 = tensorlayerx.layers.Conv2d(
        ...
        self.separableconv2d = tensorlayerx.layers.SeparableConv2d(
        ...
        self.groupconv2d = tensorlayerx.layers.GroupConv2d(
        ...
        self.binaryconv2d = tensorlayerx.layers.BinaryConv2d(
        ...
        self.dorefaconv2d = tensorlayerx.layers.DorefaConv2d(
