...
class Layer_Convolution_2D_Test(CustomTestCase):
    ...
    def setUpClass(self):
        ...
        self.conv2dlayer1 = tensorlayerx.layers.Conv2d(
            n_filter=32, in_channels=3, act=tl.ReLU, filter_size=(5, 5), strides=(2, 2), padding='SAME',
