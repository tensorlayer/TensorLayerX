    ...
    def setUpClass(cls):
        ...
        def get_network_1d(inputs, reuse=False):
            ...
            with tf.variable_scope("1D_network", reuse=reuse):
                net = tensorlayerx.layers.InputLayer(inputs)
                ...
                net6 = tensorlayerx.layers.SeparableConv1d(net5, name="SeparableConv1d1")  # 3 params
                net7 = tensorlayerx.layers.SeparableConv1d(net6, name="SeparableConv1d2")  # 3 params
    ...
    def setUpClass(cls):
        ...
        def get_network_2d(inputs, reuse=False):
            ...
            with tf.variable_scope("2D_network", reuse=reuse):
                ...
                net1 = tensorlayerx.layers.Conv2d(net, name="Conv2d")  # 2 params
                net2 = tensorlayerx.layers.DeConv2d(net1, name="DeConv2d")  # 2 params
                net3 = tensorlayerx.layers.SeparableConv2d(net2, name="SeparableConv2d")  # 3 params
                net4 = tensorlayerx.layers.MaxPool2d(net3, (1, 1), name="MaxPool2d")  # 0 params
                net5 = tensorlayerx.layers.MeanPool2d(net4, (1, 1), name="MeanPool2d")  # 0 params

                # HAO Test
                net6 = tensorlayerx.layers.Conv2d(net5, name="Conv2d1")  # 2 params
                net7 = tensorlayerx.layers.DeConv2d(net6, name="DeConv2d1")  # 2 params
                net8 = tensorlayerx.layers.DeConv2d(net7, name="DeConv2d2")  # 2 params
                net9 = tensorlayerx.layers.SeparableConv2d(net8, name="SeparableConv2d1")  # 3 params
    ...
    def setUpClass(cls):
        ...
        def get_network_3d(inputs, reuse=False):
            ...
            with tf.variable_scope("3D_network", reuse=reuse):
                ...
                net1 = tensorlayerx.layers.Conv3dLayer(
                    net, shape=(2, 2, 2, 3, 32), strides=(1, 2, 2, 2, 1), name="Conv3dLayer"
                )  # 2 params
                net2 = tensorlayerx.layers.DeConv3d(net1, name="DeConv3d")  # 2 params
                net3 = tensorlayerx.layers.MaxPool3d(net2, (1, 1, 1), name="MaxPool3d")  # 0 params
                net4 = tensorlayerx.layers.MeanPool3d(net3, (1, 1, 1), name="MeanPool3d")  # 0 params

                # HAO Test
                net5 = tensorlayerx.layers.DeConv3d(net4, name="DeConv3d1")  # 2 params
